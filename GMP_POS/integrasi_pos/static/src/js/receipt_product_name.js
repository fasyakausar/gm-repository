...
patch(Orderline.prototype, {
    ...
    getDisplayData() {
        ...
        // Tambahkan realUnitPrice jika dibutuhkan (calculated from display price / qty)
        const realUnitPrice = qty ? this.get_display_price() / qty : 0;
        displayData.realUnitPrice = this._formatCurrencyWithoutDecimals(realUnitPrice);
