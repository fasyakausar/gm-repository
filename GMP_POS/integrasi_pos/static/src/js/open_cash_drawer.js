    ...
    async _finalizeValidation() {
        ...
        if (change > 0) {
            ...
            if (hasNonCashPayment) {
                ...
                console.log("✅ Kembalian diperbolehkan karena semua pembayaran menggunakan tunai");
            }
        }
