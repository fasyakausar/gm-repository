...
class PosConfig(models.Model):
    ...
    validate_reprint_invoice = fields.Boolean("Reprint Receipt", default=False)
    ...
    is_not_admin_access = fields.Boolean(
        string='Is Not Admin Access',
        compute='_compute_is_not_admin_access',
    )
 
    def _compute_is_not_admin_access(self):
        is_admin = self.env.user.has_group(
            'custom_receipts_for_pos.group_admin_menu_access'
        )
        for rec in self:
            rec.is_not_admin_access = not is_admin